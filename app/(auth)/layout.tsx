  ...
  return (
    <div className="bg-white">
      ...
      <main className="relative flex grow">
        ...
        {/* Right side */}
        <div className="relative my-6 mr-6 hidden w-[572px] shrink-0 overflow-hidden rounded-2xl bg-white lg:block">
          {/* Background */}
          <div
          ...
          <div className="absolute left-32 top-1/2 w-[500px] -translate-y-1/2">
            <div className="aspect-video w-full rounded-2xl bg-gray-900 px-5 py-3 shadow-xl">
              ...
              <div className="font-mono text-sm text-gray-500 [&_span]:opacity-0">
                ...
                <span className="animate-[code-2_10s_infinite]">
                  --registry=https://claritynotes.co
                </span>
                <br />
