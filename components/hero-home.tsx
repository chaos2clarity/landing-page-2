      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div className="pb-12 pt-32 md:pb-20 md:pt-40">
          ...
          <div className="pb-12 text-center md:pb-16">
            ...
            <h1
              className="mb-6 border-y text-5xl font-medium [border-image:linear-gradient(to_right,transparent,theme(colors.slate.300/.8),transparent)1] md:text-6xl"
              data-aos="zoom-y-out"
              data-aos-delay={150}
            >
            ...
            <div className="mx-auto max-w-3xl">
              <p
                className="mb-8 text-lg text-gray-700 font-inter"
                data-aos="zoom-y-out"
                data-aos-delay={300}
              >
          ...
          <div
            ...
            data-aos-delay={600}
          >
            <div className="relative flex flex-col gap-4 rounded-2xl bg-grey-900 px-5 py-3 shadow-xl transition-transform hover:scale-105 before:pointer-events-none before:absolute before:-inset-5 before:border-y before:[border-image:linear-gradient(to_right,transparent,theme(colors.slate.300/.8),transparent)1] after:absolute after:-inset-5 after:-z-10 after:border-x after:[border-image:linear-gradient(to_bottom,transparent,theme(colors.slate.300/.8),transparent)1]">
